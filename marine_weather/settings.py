"""
Django settings for marine_weather project.
"""
...
DATATYPE_LOCATIONS.append('marine_weather.datatypes')
FUNCTION_LOCATIONS.append('marine_weather.functions')
ETL_MODULE_LOCATIONS.append('marine_weather.etl_modules')
SEARCH_COMPONENT_LOCATIONS.append('marine_weather.search_components')
...
SECRET_KEY = 'django-insecure-1#vwv2!p2xwp7+dlsvacsmmc9n51m77!d^z-95h@1h_k^9l_y6'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "marine_weather.urls"
ROOT_HOSTCONF = "marine_weather.hosts"

DEFAULT_HOST = "marine_weather"
...
ELASTICSEARCH_PREFIX = 'marine_weather'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'marine_weather.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    "pgtrigger",
    # "silk",
    "marine_weather",  # Ensure the project is listed before any other arches applications
)
...
WSGI_APPLICATION = 'marine_weather.wsgi.application'
...
SESSION_COOKIE_NAME = 'marine_weather'
...
# ES_MAPPING_MODIFIER_CLASSES = ["marine_weather.search.es_mapping_modifier.EsMappingModifier"]
