...
USER root
ENV PROJECT_NAME=marine_weather
...
RUN pip install -e .[dev] && \
    pip install python-dotenv boto3==1.26 django-storages==1.13 html2text cffi redis && \
...
COPY ./marine-weather/docker/entrypoint.sh ${WEB_ROOT}/entrypoint.sh
